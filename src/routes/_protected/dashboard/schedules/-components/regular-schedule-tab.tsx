...
import {
  createMachineOperatingHourFn,
  fetchMachineOperatingHourByMachineIdFn,
} from "@/utils/machineOperatingHour/machineOperatingHour.function";
import {
...
export default function RegularScheduleTab({
    ...
    onSubmit: async ({ value }) => {
      ...
      try {
        ...
        for (const day of DAYS) {
          ...
          await createMachineOperatingHourFn({
            data: {
              machineId,
  ...
  const loadMachineSchedule = async (machineId: string) => {
    ...
    try {
      const scheduleLinks = await fetchMachineOperatingHourByMachineIdFn({
