import FormBoolean from "@/components/forms/shared/form-boolean";
import FormDate from "@/components/forms/shared/form-date";
...
import FormText from "@/components/forms/shared/form-text";
...
import { listLocationByOrganizationIdFn } from "@/serverActions/location/location.function";
...
export function MachineForm({
  ...
  const { data: locations = [], isLoading: isLoadingLocations } = useQuery({
    ...
    queryFn: () =>
      listLocationByOrganizationIdFn({
        data: { organizationId: formSelectedShopId },
      }),
